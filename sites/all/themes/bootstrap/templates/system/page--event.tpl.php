  ...
  <div class="page-title-wrapper" data-stellar-background-ratio="0.5">
    ...
    <section<?php print $content_column_class; ?>>
      ...
      <?php //print render($page['content']);
	    ...
	    //print $body[0]['value'];
      //print_r($node);
      $field_banner_top_image = $node->field_banner_top_image['und'][0]['filename'];

      $field_location = $node->field_location['und'][0]['value'];
      $field_date = $node->field_date['und'][0]['value'];
      $field_from_time = $node->field_from_time['und'][0]['value'];
      $field_to_time = $node->field_to_time['und'][0]['value'];
          ...
          <main class="site-main col-sm-12 col-md-9 flex-first">
            <div class="event-single-content">
              <div class="event clearfix">
                <div class="wrapper">
                  <div class="thumbnail comingsoon-wrapper">
                    <img src="<?php echo $base_url?>/sites/default/files/<?php echo $field_banner_top_image;?>" alt="">
                    <div class="thim-countdown" data-date="December 1, 2018 17:00:00">
                    ...
                    <div class="detail clearfix">
                      ...
                      <div class="info">
                        <ul>
                          ...
                          <li class="item"><?php echo $field_from_time;?></li>
                          <li class="item"><?php echo $field_date?></li>
                        </ul>
                        <ul>
                          <li class="title"><i class="fa fa-clock-o"></i>Finish Time</li>
                          <li class="item"><?php echo $field_to_time;?></li>
                          <li class="item"><?php echo $field_date;?></li>
                        </ul>
                        <ul>
                          <li class="title"><i class="fa fa fa-map-marker"></i>Address</li>
                          <li class="item"><?php echo $field_location; ?></li>
                        </ul>
                      </div>
                    </div>
