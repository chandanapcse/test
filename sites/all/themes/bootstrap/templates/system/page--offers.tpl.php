  ...
  <div class="page-title-wrapper" data-stellar-background-ratio="0.5">
    ...
    <section<?php print $content_column_class; ?>>
      ...
      <?php //print render($page['content']);
	    ...
	    //print $body[0]['value'];
      //print_r($node);
      $field_banner_top_image = $node->field_banner_offer_image['und'][0]['filename'];
        ...
        <div class="row">
              ...
              <div class="event clearfix">
                <div class="wrapper">
                  <div class="thumbnail comingsoon-wrapper">
                    <img src="<?php echo $base_url?>/sites/default/files/<?php echo $field_banner_top_image;?>" alt="<?php echo $title; ?>">
                  </div>
                  <div class="content">
          ...
          <aside id="secondary" class="widget-area col-sm-12 col-md-3 sticky-sidebar">
            <div class="wd wd-book-event">
              <h3 class="wd-title">Take Offer</h3>
