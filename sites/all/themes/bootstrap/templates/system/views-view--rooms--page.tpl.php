  ...
  <div class="site-content container">
    <div class="rooms-content layout-grid style-02">
      ...
      foreach ($view->result as $viewresult) {
        ...
        $images_new = $node_obj->field_front_room_image['und'][0]['filename'];
        $room_type = $node_obj->field_room_type['und'][0]['value'];
        $price = $node_obj->field_price['und'][0]['value'];
        ...
        <div class="room col-sm-6 clearfix">
          <div class="room-item">
            <div class="room-media">
              <a href="<?php echo $url;?>"><img src="<?php echo $base_url;?>/sites/default/files/<?php echo $images_new; ?>" alt="<?php echo $images_new; ?>"></a>
            </div>
            <div class="room-summary">
              <h3 class="room-title">
                <a href="<?php echo $url;?>"><?php echo $node_title;?></a>
              </h3>
              <div class="room-price">From: <span class="price"><?php echo $price;?></span></div>
