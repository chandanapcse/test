  ...
  <div class="site-content container">
    <div class="blog-content layout-grid">
      ...
      foreach ($view->result as $viewresult) {
        ...
        $images_new = $node_obj->field_blog_front_image['und'][0]['filename'];
            ...
            <article class="post col-sm-4 clearfix">
              <div class="post-content">
                ...
                <div class="post-summary">
                  ...
                  <p class="post-description" lang="zxx"><?php echo $summary; ?></p>
                  <a href="<?php echo $url; ?>" class="btn-icon">Read more</a>
                </div>
              </div>
            </article>
